  ...
  const departments = [
    {
      ...
      descriptionKey:
        language === "mr"
          ? "जि.प.शाळा विठ्ठलवाडी संचलन आणि व्यवस्थापन."
          : "Manages Z.P. School Vitthalwadi operations and administration.",
    ...
    },
    {
      ...
      descriptionKey:
        language === "mr"
          ? "तलाठी कार्यालयातील महसूल संबंधित कार्यांची जबाबदारी."
          : "Handles revenue-related activities at the Talathi office.",
    ...
    {
      id: 4,
      nameKey: language === "en" ? "Anganwadi Department" : "अंगणवाडी विभाग",
      icon: FaChild,
      color: "from-pink-400 to-pink-600",
      descriptionKey:
        language === "mr"
          ? "अंगणवाडी केंद्रांचे संचालन आणि बालकल्याणाची जबाबदारी."
          : "Manages Anganwadi centers and child welfare activities.",
      link: "/departments/anganwadi",
    },
    {
      id: 5,
