          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="flex gap-4">
                <a
                  href="https://www.facebook.com/profile.php?id=100079825773209&imbextid=ZbWKwl"
                  className="w-12 h-12 bg-blue-600 text-white rounded-lg flex items-center justify-center hover:bg-blue-700 transition-colors"
                >
                  <FaFacebook className="text-xl" />
                </a>
                <a
                  href="https://www.instagram.com/vitthalvadi?igsh=YzljYTk110Dg3Zg=="
                ...
                <a
                  href="https://youtube.com/@vitthalwadigrampanchayt?si=op0qMxElsk2pyFzH"
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="w-full aspect-[3/2] bg-gray-200 relative overflow-hidden">
              <iframe
                ...
                width={1240}
                height={800}
                src="https://maps.google.co.in/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=Vithalwadi+Yavatmal+Yavatmal+Maharashtra&amp;t=h&amp;ie=UTF8&amp;hq=Vithalwadi&amp;hnear=Yavatmal+Yavatmal+Maharashtra&amp;output=embed&amp;iwloc=near"
              ></iframe>
            </div>
          </div>
        </div>
