  ...
  const subPages = [
    {
      ...
      head: language === "en" ? "Shraddha Sanjay Patil" : "श्रद्धा संजय पाटील",
      phone: language === "en" ? "+91-9579587807" : "+९१-९५७९५८७८०७",
      icon: FaBookOpen,
      color: "from-yellow-400 to-yellow-600",
    },
    {
      nameKey: "dept.revenue",
      name: language === "en" ? "Revenue Department" : "महसूल विभाग",
      description:
        language === "mr"
          ? "भूविषयक नोंदी व महसूल कामकाज."
          : "Handles land records and revenue work.",
      head: language === "en" ? "Ashok Lonishta" : "अशोक लोणीष्ट",
      phone: language === "en" ? "" : "",
    ...
    },
    {
      ...
      head: language === "en" ? "Taklikar" : "टाकळीकर",
      phone: language === "en" ? "+91-9850656586" : "+९१-९८५०६५६५८६",
      icon: FaHeartbeat,
      color: "from-red-400 to-red-600",
    },
    {
      nameKey: "dept.anganwadi",
      name: language === "en" ? "Anganwadi Department" : "अंगणवाडी विभाग",
      description:
        language === "mr"
          ? "बालविकास व पोषण सेवा."
          : "Child development and nutrition services.",
      head:
        language === "en"
          ? "Kalpana Subhash Suryavanshi"
          : "कल्पना सुभाष सूर्यवंशी",
      phone: language === "en" ? "+91-9421132569" : "+९१-९४२११३२५६९",
      icon: FaChild,
    ...
    },
    {
      ...
      head: language === "en" ? "Sunita Shivdas" : "सुनिता शिवदास",
      phone: language === "en" ? "+91-8669429768" : "+९१-८६६९४२९७६८",
      icon: FaSeedling,
